...
export default function AppRoutes() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/" element={<Navigate to={hasStorageData ? '/account' : 'signup'} replace />} />
        <Route path="/signin" element={<RenderComponent hasData={hasStorageData} Component={SignIn}/>} />
        <Route path="/signup" element={<RenderComponent hasData={hasStorageData} Component={SignUp}/>} />
